    ...
    >
      <div className="max-w-6xl mx-auto">
        ...
        >
          ...
          >
            <Avatar className="w-full h-full ring-4 ring-indigo-500 ring-offset-4 ring-offset-transparent">
              <Zoom>
              <AvatarImage src="/muzammal.jpg" alt="Profile" className="object-cover" />
              </Zoom>
          ...
          <div className="flex-1 text-center md:text-left">
            ...
            <motion.h2 
              className="text-xl md:text-2xl text-indigo-500 dark:text-green-500 mb-4"
              variants={itemVariants}
            >
              {user.title}
            </motion.h2>
            ...
            <motion.div className="flex flex-wrap gap-4 justify-center md:justify-start">
              <Button
                ...
                className="group text-gray-900 dark:text-gray-300 border-indigo-500 hover:bg-indigo-500"
              >
                <Mail className="mr-2 h-4 w-4" />
                Contact Info
              </Button>
              <Button variant="outline" className="text-gray-900 dark:text-gray-300 border-indigo-500 hover:bg-indigo-500" onClick={()=>router.push('/contact')}>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        >
          <TabsList className="w-full justify-center lg:justify-start bg-white/10 border-2 dark:border-0 dark:bg-white/10 backdrop-blur-lg p-1 rounded-xl">
            <TabsTrigger
              value="experience"
              className="text-gray-900 dark:text-gray-300 data-[state=active]:bg-gray-200 data-[state=active]:dark:bg-green-600 data-[state=active]:text-indigo-600 data-[state=active]:dark:text-white rounded-lg px-3 py-2 transition-colors"
            >
              <Briefcase className="mr-2 h-4 w-4 text-indigo-400 dark:text-white" />
              Experience
            </TabsTrigger>
            <TabsTrigger
              value="education"
              className="text-gray-900 dark:text-gray-300 data-[state=active]:bg-gray-200 data-[state=active]:dark:bg-green-600 data-[state=active]:text-indigo-600 data-[state=active]:dark:text-white rounded-lg px-3 py-2 transition-colors"
            >
              <GraduationCap className="mr-2 h-4 w-4 text-indigo-400 dark:text-white" />
              Education
            </TabsTrigger>
            <TabsTrigger
              value="skills"
              className="text-gray-900 dark:text-gray-300 data-[state=active]:bg-gray-200 data-[state=active]:dark:dark:bg-green-600 data-[state=active]:text-indigo-600 data-[state=active]:dark:text-white rounded-lg px-3 py-2 transition-colors"
            >
              <CodeXml className="mr-2 h-4 w-4 text-indigo-400 dark:text-white" />
              Skills
            </TabsTrigger>
          </TabsList>
          ...
          <TabsContent value="experience" className="mt-6">
            ...
            >
              {user.experience.map((exp, index) => (
                ...
                >
                  <h3 className="text-xl font-semibold text-indigo-500 dark:text-green-500">{exp.position}</h3>
            ...
            >
              {user.education.map((edu, index) => (
                <motion.div
                  ...
                  className="bg-white/10 border-gary-900 border-2 dark:border-0 dark:bg-white/10 backdrop-blur-lg rounded-xl p-6 text-white"
                >
                  <h3 className="text-xl font-semibold text-indigo-500 dark:text-green-500">{edu.degree}</h3>
                  <div className="flex items-center gap-2 mt-2 text-gray-900 dark:text-gray-300">
          ...
          <TabsContent value="skills" className="mt-6">
            ...
            >
              {Object.entries(user.skills).map(([category, skills]) => (
                ...
                >
                  <h3 className="text-xl font-semibold text-indigo-500 dark:text-green-500 mb-4 capitalize">
                    {category}
                  </h3>
                      ...
                      <div key={idx} className="space-y-2">
                        ...
                        <div className="relative w-full">
                          ...
                          <Progress 
                            ...
                            className="h-2 bg-indigo-500 rounded-full" // Filled area
                          />
                        </div>
                      </div>
                    ))}
